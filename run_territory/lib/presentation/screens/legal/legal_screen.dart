...
1. Data We Collect
Run Territory collects GPS location data while you are actively running. This data is stored locally on your device and is never transmitted to external servers in the Free version.
...
1. Acceptance
By using Run Territory, you agree to these Terms of Use.

2. License
Run Territory grants you a limited, non-exclusive, non-transferable license to use the app for personal, non-commercial purposes.

3. Prohibited Use
You may not reverse-engineer, modify, or distribute the app. You may not use the app for any unlawful purpose.

4. GPS & Safety
Run Territory uses your GPS location. Always pay attention to your surroundings while running. We are not liable for any accidents or injuries.
...
1. Erhobene Daten
Run Territory erfasst GPS-Standortdaten, während du aktiv läufst. Diese Daten werden lokal auf deinem Gerät gespeichert und in der kostenlosen Version nicht an externe Server übertragen.
...
1. Zustimmung
Durch die Nutzung von Run Territory stimmst du diesen Nutzungsbedingungen zu.

2. Lizenz
Run Territory gewährt dir eine eingeschränkte, nicht-exklusive, nicht übertragbare Lizenz zur persönlichen, nicht-kommerziellen Nutzung der App.

3. Verbotene Nutzung
Du darfst die App nicht zurückentwickeln, modifizieren oder verbreiten. Eine rechtswidrige Nutzung ist nicht gestattet.

4. GPS & Sicherheit
Run Territory nutzt deinen GPS-Standort. Achte beim Laufen stets auf deine Umgebung. Wir haften nicht für Unfälle oder Verletzungen.
...
1. 수집하는 정보
Run Territory는 달리기 중 GPS 위치 데이터를 수집합니다. 이 데이터는 기기에 로컬로 저장되며, 무료 버전에서는 외부 서버로 전송되지 않습니다.
...
1. 동의
Run Territory를 사용함으로써 본 이용약관에 동의하는 것으로 간주됩니다.

2. 라이선스
Run Territory는 개인적, 비상업적 목적으로 앱을 사용할 수 있는 제한적, 비독점적, 양도 불가능한 라이선스를 부여합니다.

3. 금지 행위
앱을 역공학, 수정 또는 배포할 수 없습니다. 불법적인 목적으로 앱을 사용하는 것은 금지됩니다.

4. GPS 및 안전
Run Territory는 GPS 위치를 사용합니다. 달리기 중 항상 주변 환경에 주의하세요. 사고나 부상에 대해 당사는 책임지지 않습니다.
